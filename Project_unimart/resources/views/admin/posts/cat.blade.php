        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ url('admin/posts/cat/store') }}" enctype="multipart/form-data">
                            @csrf
                            {{-- Form-name-cat --}}
                            <div class="col-6">
            ...
            <div class="col-12 mt-2">
                <div class="card">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('admin.post.cat.change', $cat->id) }}"
                                                        ...
                                                        onclick="return confirm('Xác nhận chuyển danh mục {{ $cat->cat_name }} sang trạng thái {{ $cat->status == 'Công khai' ? 'Chờ duyệt' : 'Công khai' }}');">
                                                    ...
                                                    <a href="{{ route('admin.post.cat.delete', $cat->id) }}"
                                                        onclick="return confirm('Bạn có chắc chắn xóa danh mục {{$cat->cat_name}} này không ?')"
                    ...
                    @else
                        <td colspan="7">
                            <p class="text-danger">Không có danh mục bài viết nào trong hệ thống !</p>
                        </td>
                    @endif
                </div>
            </div>

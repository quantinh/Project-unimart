...
<div class="col l-3 mobile-on-hide">
    ...
    <div class="section">
        <ul class="list-section">
            ...
            <li class="item-section">
                <a class="item-section-link" href="" title="">{{ $page->title }}</a>
            </li>
        </ul>
    </div>
    {{-- Product-selling  --}}
    ...
    {{-- Đổ dữ liệu banner --}}
    @foreach($banners_position_sidebar_two as $banner)
        <div class="box-banner">
            <a href="" class="box-banner-link">
                <img src="{{ asset($banner->image) }}" alt="" class="box-banner-link-img">
            </a>
        </div>
    @endforeach
</div>

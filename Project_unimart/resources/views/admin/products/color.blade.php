        ...
        <div class="row">
            <div class="col-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ url('admin/products/color/store') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <img style="min-width: 16px; min-height: 16px; box-sizing: unset; box-shadow: none; background: unset; padding: 0 6px 0 0; cursor: pointer;"
                                    ...
                                    class="colorpick-eyedropper-input-trigger" alt="Chọn màu sắc">
                                <input class="form-control" type="color" name="color_select" value="#333"
                                    id="colorpicker" colorpick-eyedropper-active="true">
                                @error('color_select')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input id="hexcolor" name="code_color" value="{{ old('code_color') }}"
                                    class="form-control text-center" style="font-weight: 700; text-transform: uppercase"
                                    disabled>
                                @error('code_color')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
            ...
            <div class="col-8">
                ...
                <div class="card">
                                    ...
                                    @foreach ($colors as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <span class="badge badge-warning d-inline-block p-2"
                                                    style="border: 1px solid gray; background-color: {{ $item->code_color }}"></span>
                                            </td>
                                            <td class="text-center">
                    ...
                    @else
                        <td colspan="7">
                            <p class="text-danger">Không có danh mục mã màu nào trong hệ thống !</p>
                        </td>
                    @endif
                </div>
                {{-- Thanh phân trang --}}
